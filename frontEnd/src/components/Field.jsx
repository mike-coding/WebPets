...
function Field({ title, value, setValue, hide = false }) {
    return (
      <div className="FIELD___ flex flex-col sm:flex-row w-full sm:w-3/4 lg:w-1/2 max-w-md items-stretch sm:items-center font-m6x11 text-2xl sm:text-3xl lg:text-4xl text-white bg-gray-900/30 shadow-md rounded-sm justify-start tracking-wide pointer-events-auto">
