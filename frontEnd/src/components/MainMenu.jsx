...
function MainMenu() {
  const { navigation } = useNavigationContext();  return (
    <div className="w-6/7 sm:w-5/7 h-[80vh] flex flex-col items-center backdrop-blur-xs backdrop-brightness-150 backdrop-contrast-60 shadow-xl rounded-sm px-4 sm:px-0 pointer-events-auto">
