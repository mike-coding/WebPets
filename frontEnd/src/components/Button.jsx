function Button ({ name, onClick })
{
    return (        <div 
        ...
        tracking-wide transform transition duration-200 hover:scale-110 hover:cursor-default hover:bg-gray-900/50 select-none active:scale-100 pointer-events-auto">
        {name}
    </div>
    );
}
